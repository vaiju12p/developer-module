...
public class CascAssn4_Join_TestCase {
    ...
    public void itShouldReturnTheFilteredData() {
        ...
        Data corpus1 = new com.hotels.plunger.DataBuilder(new Fields("Account_Number1","Name"))
        ...
        Data corpus2 = new com.hotels.plunger.DataBuilder(new Fields("Account_Number","Transaction_Amount"))
